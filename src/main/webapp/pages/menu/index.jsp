...
<div class="menuBorder">
    ...
    <div id="content">
        ...
        <form class="form-inline" style="align-content: center">
            <input class="form-control mr-sm-2" type="search" aria-label="Search" placeholder="Я хочу найти"
                   style=" display: inline-block; margin-left: 30% ;width:300px;">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit"
                    style=" display: inline-block;  width:100px;">Поиск
            </button>
        </form>
    </div>
</div>
...
<div style="padding-left: 150px">
    <div class="menu">
        ...
        <ul>
            <li class="nav-item">
                <a class="nav-link" href="/pages/categories/fiction.jsp" style="color: black;">Художественная
                    литература</a>
            </li>
            <li class="nav-item">
    ...
    <div class="menu">
        ...
        <ul>
            <li class="nav-item">
                <a class="nav-link" href="/pages/categories/paperSupplies.jsp" style="color: black;">Бумажные
                    принадлежности</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/pages/categories/stationery.jsp" style="color: black;">Канцелярские
                    мелочи</a>
            </li>
        </ul>
    </div>
